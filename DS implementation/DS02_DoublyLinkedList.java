class DoublyLinkedList{
    ...
    public void addFirst(int data){
        ...
        if(head == null){
            ...
            //step 2 -> newNode point to head Node(using next pointer) & head node point to the NewNode(using prev pointer)
        newNode.next = head;
        head.prev = newNode;
    ...
    public void addLast(int data){
        ...
        if(head == null){
            ...
            //step 2 -> tail point to the newNode
        tail.next = newNode;
            //step 3 -> newNode point to  the tail Node
        newNode.prev = tail;
...
public class DS02_DoublyLinkedList {

public class BT07_TransfromToSumTree {
    ...
    public static int transformToSumTree(Node root){
        ...
        int leftSide = transformToSumTree(root.left);   //check left side of current root
        int rightSide = transformToSumTree(root.right); //check right side of current root

        int data = root.data;   //it store original value of current root
